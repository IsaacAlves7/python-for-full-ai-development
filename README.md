...
Uma regra é formada por uma <em>premissa simples ou composta</em> (usando operadores lógicos) e uma ou mais conclusões que são acionadas quando as premissas são verdadeiras</p>
