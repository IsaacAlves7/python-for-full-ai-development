...
<h3>🔎🕳️🌳 Descrição das estratégias de busca em profundidade 🌳🕳️🔍</h3>
...
A estratégia consiste em expandir os estados a partir do estado inicial, aplicando qualquer um dos possíveis operadores aplicáveis àquele estado. A escolha do operador pode sr aleatória ou seguir uma sequência arbitrária de testes de possibilidade de aplicação dos operadores. Caso não haja operadores possíveis de aplicar ou caso todos os estados gerados já constem da árvore, o método fracassa. O método obtém sucesso apenas se atinge um estado final.</p>
